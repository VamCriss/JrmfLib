...
@interface JrmfBusinessWalletSDK : NSObject
 ...
 */
+ (void)instanceJrmfBusinessWalletSDKWithPartnerId:(NSString *)partnerId AppMethod:(BOOL)isOnline;
 ...
 */
- (void)doPresentJrmfWalletPageWithBaseViewController:(UIViewController *)baseViewController userId:(NSString *)userId  thirdToken:(NSString *)thirdToken;
